...
![图片](RDMA介绍.assets/640-1772022848068-3.webp)
...
![图片](RDMA介绍.assets/640-1772022862079-6.webp)

### RDMA操作类型

![图片](RDMA介绍.assets/640-1772022866550-9.webp)
...
![图片](RDMA介绍.assets/640-1772022871384-12.webp)
...
![图片](RDMA介绍.assets/640-1772022875096-15.webp)
...
![图片](RDMA介绍.assets/640-1772022877424-18.webp)

**AETH扩展传输头**

接收端响应报文，告知发送端数据是否正常

![图片](RDMA介绍.assets/640-1772022879210-21.webp)

syndrome的bit5:6代表ACK或NAK

![图片](RDMA介绍.assets/640-1772022880606-24.webp)

bit5:6为11表示NAK，说明有错误发送，bit4:4标识错误原因

![图片](RDMA介绍.assets/640-1772022882016-27.webp)
...
![图片](RDMA介绍.assets/640-1772022883915-30.webp)

- write middle报文只包含BTH头

![图片](RDMA介绍.assets/640-1772022885723-33.webp)

- write last报文只包含BTH头，并且BTH的reqack设置为1，接收端只会对此报文响应ack

![图片](RDMA介绍.assets/640-1772022887279-36.webp)

如果数据长度小于MTU则不分片，报文类型为write only，每个报文包含BTH和RETH头，其中BTH的reqack为1，RETH指定远端地址和key

![图片](RDMA介绍.assets/640-1772022888897-39.webp)
...
![图片](RDMA介绍.assets/640-1772022891372-42.webp)
...
![图片](RDMA介绍.assets/640-1772022893989-45.webp)
