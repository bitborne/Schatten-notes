---
title: '0x04-线程池'
description: '本文深入浅出地介绍了线程池的原理及其在处理高并发请求和异步 I/O 中的重要作用，并提供了一个基于 C 语言实现的线程池示例代码。'
pubDate: 2026-02-20
---
...
+ **<font style="color:#DF2A3F;">"任务队列不为空"（</font>**`pool->task_queue != NULL`**<font style="color:#DF2A3F;">）</font>**
+ **<font style="color:#DF2A3F;">"线程池需要关闭"（</font>**`pool->shutdown == 1`**<font style="color:#DF2A3F;">）</font>**
...
+ `cond`**<font style="color:#DF2A3F;">（条件变量）</font>**不是条件本身，**<u><font style="color:#DF2A3F;">只是用来通知条件可能变化的工具</font></u>**
